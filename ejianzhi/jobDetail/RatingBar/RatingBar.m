...
-(void)tap:(UITapGestureRecognizer *)gesture{
    if(self.enable){
        ...
        if ([_delegate respondsToSelector:@selector(selectedAfter:)])
        {
            [_delegate selectedAfter:self];
        }
    }
}
/*
